...
@section('content_header')
    <h1 class="m-0 text-dark">申报企业</h1>
@stop
    ...
    <div class="row">
        <div class="col-12">
            <form action="" class="form-row">
                ...
                <button type="submit" class="btn btn-white btn-info btn-bold" style="margin-right: 3px;">
       ...
       let dt = $('table').dataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    data: null,
                    render: function (data, type, row) {
                        return '<a href="/enterprise/' + row.id + '" target="_blank">详情</a>';
                    }
                }
            ],
